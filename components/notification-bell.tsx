...
export function NotificationBell({ userId }: Props) {
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {open && (
        // Anchor left (not right) so the panel opens *into* the main chat
        // pane instead of leftward across the sidebar's left edge — with
        // `right-0` the 320-px panel was extending beyond the 288-px
        // sidebar and getting visually clipped by neighbouring columns.
        <div className="absolute left-0 mt-1 w-80 max-w-[calc(100vw-1rem)] max-h-[70vh] overflow-y-auto bg-surface border border-border rounded-lg shadow-xl z-[60]">
